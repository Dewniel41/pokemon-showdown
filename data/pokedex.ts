export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	oddisharizonia: {
		num: 2000,
		name: "Oddish-Arizonia",
		forme: "Arizonia",
		types: ["Ground", "Ghost"],
		baseStats: { hp: 49, atk: 46, def: 52, spa: 78, spd: 60, spe: 35 },
		abilities: { 0: "Dry Skin", H: "Sturdy" },
		heightm: 0.5,
		weightkg: 5.4,
		color: "Purple",
		evos: ["Gloom-Arizonia"],
	...
	gloomarizonia: {
		...
		forme: "Arizonia",
		types: ["Ground", "Ghost"],
		baseStats: { hp: 70, atk: 54, def: 74, spa: 80, spd: 81, spe: 36 },
		abilities: { 0: "Dry Skin", H: "Sturdy" },
		heightm: 0.8,
		weightkg: 8.6,
		color: "Purple",
		evos: ["Vileplume-Arizonia", "Embossom"],
		prevo: "Oddish-Arizonia",
		evoLevel: 21,
		eggGroups: ["Grass"],
	},
	...
	vileplumearizonia: {
		num: 2002,
		name: "Vileplume-Arizonia",
		forme: "Arizonia",
		types: ["Ground", "Ghost"],
		baseStats: { hp: 101, atk: 60, def: 91, spa: 107, spd: 92, spe: 39 },
		abilities: { 0: "Dry Skin", H: "Sturdy" },
		heightm: 1.6,
		weightkg: 22.1,
		color: "Purple",
		prevo: "Gloom-Arizonia",
		evoItem: "Dusk Stone",
		eggGroups: ["Grass"],
	},
	...
	embossom: {
		...
		name: "Embossom",
		types: ["Fire", "Ghost"],
		baseStats: { hp: 101, atk: 75, def: 53, spa: 107, spd: 62, spe: 92 },
	...
	grock: {
		...
		name: "Grock",
		types: ["Rock", "Psychic"],
		baseStats: { hp: 83, atk: 74, def: 54, spa: 75, spd: 87, spe: 67 },
	...
	packgod: {
		...
		name: "PACKGOD",
		types: ["Fire"],
		baseStats: { hp: 100, atk: 140, def: 60, spa: 65, spd: 45, spe: 50 },
		abilities: { 0: "Arena Trap", H: "Bad Dreams" },
		heightm: 2.5,
		weightkg: 300,
		color: "Red",
		eggGroups: ["Undiscovered"],
	...
	duke: {
		...
		name: "Duke",
		types: ["Normal", "Fire"],
		baseStats: { hp: 100, atk: 85, def: 95, spa: 65, spd: 60, spe: 60 },
		abilities: { 0: "Guts", H: "Runaway" },
		heightm: 2,
		weightkg: 200,
		color: "Black",
		eggGroups: ["Undiscovered"],
	...
	littleduu: {
		...
		name: "Little Duu",
		types: ["Normal"],
		baseStats: { hp: 65, atk: 65, def: 105, spa: 85, spd: 65, spe: 75 },
		abilities: { 0: "Filter", H: "Moody" },
		heightm: 0.4,
		weightkg: 8,
		color: "White",
		eggGroups: ["Undiscovered"],
	...
	castlecrashers: {
		...
		types: ["Fighting", "Steel"],
		baseStats: { hp: 78, atk: 112, def: 73, spa: 60, spd: 72, spe: 70 },
		abilities: { 0: "Battle Armor" },
		heightm: 1.5,
		weightkg: 200,
		color: "Blue",
	...
	peashooter: {
		...
		name: "Peashooter",
		types: ["Grass"],
		baseStats: { hp: 50, atk: 90, def: 71, spa: 90, spd: 77, spe: 52 },
		abilities: { 0: "Overgrow", 1: "Sap Sipper", H: "Seed Sower" },
		heightm: 0.3,
		weightkg: 2,
		color: "Green",
		eggGroups: ["Undiscovered"],
	...
	repeater: {
		...
		name: "Repeater",
		types: ["Grass", "Fighting"],
		baseStats: { hp: 90, atk: 100, def: 71, spa: 100, spd: 77, spe: 62 },
		abilities: { 0: "Overgrow", 1: "Sap Sipper", H: "Seed Sower" },
		heightm: 0.3,
		weightkg: 2,
		color: "Green",
	...
	snowpea: {
		...
		name: "Snow Pea",
		types: ["Grass", "Ice"],
		baseStats: { hp: 75, atk: 95, def: 61, spa: 95, spd: 67, spe: 77 },
		abilities: { 0: "Overgrow", 1: "Sap Sipper", H: "Snow Warning" },
		heightm: 0.3,
		weightkg: 2,
		color: "Blue",
		eggGroups: ["Undiscovered"],
	...
	cattail: {
		...
		name: "Cattail",
		types: ["Grass", "Water"],
		baseStats: { hp: 85, atk: 64, def: 81, spa: 94, spd: 82, spe: 84 },
	...
	sunflower: {
		...
		name: "Sunflower",
		types: ["Grass", "Fire"],
		baseStats: { hp: 90, atk: 42, def: 58, spa: 82, spd: 125, spe: 78 },
		abilities: { 0: "Sunlight" },
		heightm: 0.4,
		weightkg: 5,
		color: "Yellow",
		eggGroups: ["Undiscovered"],
	...
	chomper: {
		...
		name: "Chomper",
		types: ["Grass", "Poison"],
		baseStats: { hp: 110, atk: 110, def: 90, spa: 62, spd: 48, spe: 95 },
	...
	walnut: {
		...
		name: "Walnut",
		types: ["Grass", "Ground"],
		baseStats: { hp: 110, atk: 70, def: 100, spa: 55, spd: 100, spe: 50 },
	...
	bucketheadzombie: {
		...
		types: ["Steel"],
		baseStats: { hp: 100, atk: 80, def: 85, spa: 45, spd: 80, spe: 60 },
		abilities: { 0: "Unaware" },
		heightm: 1.5,
		weightkg: 77,
		color: "Gray",
	...
	flagzombie: {
		...
		name: "Flag Zombie",
		types: ["Normal"],
		baseStats: { hp: 70, atk: 85, def: 75, spa: 65, spd: 75, spe: 80 },
		abilities: { 0: "Speed Boost" },
		heightm: 1.5,
		weightkg: 52,
		color: "Gray",
	...
	zomboni: {
		...
		name: "Zomboni",
		types: ["Ice", "Steel"],
		baseStats: { hp: 150, atk: 100, def: 70, spa: 50, spd: 30, spe: 60 },
	...
	balloonzombie: {
		...
		name: "Balloon Zombie",
		types: ["Normal"],
		baseStats: { hp: 70, atk: 95, def: 65, spa: 65, spd: 90, spe: 95 },
		abilities: { 0: "Levitate" },
		heightm: 1.4,
		weightkg: 58,
		color: "Gray",
	...
	dancingzombie: {
		...
		name: "Dancing Zombie",
		types: ["Psychic"],
		baseStats: { hp: 80, atk: 65, def: 65, spa: 100, spd: 85, spe: 95 },
		abilities: { 0: "Dancer" },
		heightm: 1.7,
		weightkg: 81,
		color: "Gray",
	...
	spllotch: {
		...
		name: "Spllotch",
		types: ["Fairy", "Ground"],
		baseStats: { hp: 45, atk: 45, def: 45, spa: 150, spd: 45, spe: 45 },
		abilities: { 0: "Slow Start" },
		heightm: 1.3,
		weightkg: 20,
		color: "Pink",
	...
	scarffle: {
		...
		name: "Scarffle",
		types: ["Fire"],
		baseStats: { hp: 85, atk: 115, def: 80, spa: 75, spd: 70, spe: 90 },
		abilities: { 0: "Insomnia", H: "Merciless" },
		heightm: 1,
		weightkg: 60,
		color: "Red",
		eggGroups: ["Undiscovered"],
	...
	meltyffle: {
		...
		name: "Meltyffle",
		types: ["Fire", "Ghost"],
		baseStats: { hp: 85, atk: 75, def: 70, spa: 115, spd: 80, spe: 90 },
		abilities: { 0: "Infiltrator", H: "Liquid Ooze" },
		heightm: 1.2,
		weightkg: 75,
		color: "Red",
		eggGroups: ["Undiscovered"],
	...
	robotffle: {
		...
		name: "Robotffle",
		types: ["Steel", "Fighting"],
		baseStats: { hp: 85, atk: 105, def: 65, spa: 105, spd: 65, spe: 90 },
		abilities: { 0: "Sharpness", H: "Sniper" },
		heightm: 1.5,
		weightkg: 100,
		color: "Gray",
		eggGroups: ["Undiscovered"],
	...
	tropicffle: {
		...
		name: "Tropicffle",
		types: ["Water"],
		baseStats: { hp: 95, atk: 80, def: 115, spa: 65, spd: 105, spe: 35 },
	...
	wcorpdon: {
		...
		name: "W Corp Don",
		types: ["Electric"],
		baseStats: { hp: 82, atk: 99, def: 70, spa: 60, spd: 76, spe: 99 },
		abilities: { 0: "Hustle", 1: "Early Bird", H: "Infiltrator" },
		heightm: 1,
		weightkg: 50,
		color: "Gray",
		eggGroups: ["Undiscovered"],
	...
	judas: {
		...
		name: "Judas",
		types: ["Fairy", "Fighting"],
		baseStats: { hp: 89, atk: 92, def: 80, spa: 72, spd: 86, spe: 81 },
		abilities: { 0: "Defiant" },
		heightm: 1.8,
		weightkg: 90,
		color: "Pink",
	...
	repoduu: {
		...
		name: "R.E.P.O Duu 😂",
		types: ["Rock"],
		baseStats: { hp: 94, atk: 82, def: 68, spa: 63, spd: 111, spe: 60 },
		abilities: { 0: "Gluttony", 1: "Harvest", H: "Hustle" },
		heightm: 1.5,
		weightkg: 52,
		color: "Gray",
		eggGroups: ["Undiscovered"],
	...
	dolphinemulator: {
		...
		types: ["Water"],
		baseStats: { hp: 76, atk: 92, def: 63, spa: 83, spd: 57, spe: 94 },
		abilities: { 0: "Swift Swim", H: "Download" },
		heightm: 1.8,
		weightkg: 90,
		color: "Blue",
		eggGroups: ["Undiscovered"],
	...
	tastywaterimage: {
		num: 2031,
		name: "Tasty Water Image",
		types: ["Water"],
		baseStats: { hp: 85, atk: 57, def: 100, spa: 63, spd: 103, spe: 74 },
	...
	bracken: {
		...
		name: "Bracken",
		types: ["Grass", "Dark"],
		baseStats: { hp: 90, atk: 100, def: 40, spa: 100, spd: 40, spe: 105 },
		abilities: { 0: "Pressure", H: "Emergency Exit" },
		heightm: 1.8,
		weightkg: 90,
		color: "Green",
		eggGroups: ["Undiscovered"],
	...
	silverwolf: {
		...
		name: "Silver Wolf",
		types: ["Electric", "Psychic"],
		baseStats: { hp: 65, atk: 62, def: 61, spa: 100, spd: 93, spe: 109 },
		abilities: { 0: "Static" },
		heightm: 1.5,
		weightkg: 85,
		color: "Gray",
	...
	granny: {
		...
		name: "Granny",
		types: ["Normal"],
		baseStats: { hp: 92, atk: 97, def: 84, spa: 62, spd: 82, spe: 62 },
		abilities: { 0: "Steadfast" },
		heightm: 1.5,
		weightkg: 85,
		color: "Gray",
	...
	king: {
		...
		name: "King",
		types: ["Dark", "Normal"],
		baseStats: { hp: 90, atk: 60, def: 75, spa: 75, spd: 75, spe: 50 },
		abilities: { 0: "Asshole" },
		heightm: 1.5,
		weightkg: 85,
		color: "Gray",
