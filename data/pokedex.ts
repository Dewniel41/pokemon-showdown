export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	oddish: {
		...
		evos: ["Gloom"],
		eggGroups: ["Grass"],
		otherFormes: ["Oddish-Arizonia"],
		formeOrder: ["Oddish", "Oddish-Arizonia"],
	},
	gloom: {
		num: 44,
		name: "Gloom",
		...
		eggGroups: ["Grass"],
		otherFormes: ["Gloom-Arizonia"],
		formeOrder: ["Gloom", "Gloom-Arizonia"],
	},
	vileplume: {
		num: 45,
		name: "Vileplume",
		...
		evoItem: "Leaf Stone",
		eggGroups: ["Grass"],
		otherFormes: ["Vileplume-Arizonia"],
		formeOrder: ["Vileplume", "Vileplume-Arizonia"],
	},
	paras: {
		num: 46,
		name: "Paras",
